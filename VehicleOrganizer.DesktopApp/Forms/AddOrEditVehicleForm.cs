    ...
    public partial class AddOrEditVehicleForm : Form, IModelable<Vehicle>, IDebugable
    {
        ...
        private async void buttonAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (_isEditMode)
            {
                ...
                _mainForm.PlacePanel(new VehiclePanel(Model, _vehicleRepository, _mapper));
            }
            else
            {
                ...
                _mainForm.PlacePanel(new VehiclePanel(justAddedVehicle, _vehicleRepository, _mapper));
            }
